...
struct sGraphicsObject {
    // If m_Texture is null an draw tick, then this object
    // is geometry object. Use m_Geometry for details
    ...
    sGraphicsObject() : m_Angle(0), m_Opacity(255), 
                       m_Texture(nullptr), m_Geometry(nullptr),
                       m_Z(0), m_IsVisible(true),
    ...
    sGraphicsObject(double angle, uint8_t opacity, cTextureBase *texture) : 
                       ...
                       m_Texture(texture), m_Geometry(nullptr),
                       m_Z(0), m_IsVisible(true),
                       m_IsSection(false), m_IsAnimation(false) { 
