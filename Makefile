...
debug: $(OBJDIR)main.o $(OBJDIR)cAnimation.o $(OBJDIR)cAnimationManager.o $(OBJDIR)animationMain.o $(OBJDIR)cMain.o $(OBJDIR)cTimedCallbackManager.o $(OBJDIR)cTextureManager.o $(OBJDIR)cGraphicsSDL2.o $(OBJDIR)cTextureSDL2.o $(OBJDIR)cGraphicsManager.o $(OBJDIR)graphicsMain.o $(OBJDIR)cGraphicsBase.o $(OBJDIR)cTextureBase.o $(OBJDIR)statesMain.o $(OBJDIR)cStateManager.o $(OBJDIR)cStateBase.o $(OBJDIR)cFileSystem.o $(OBJDIR)cFileParser.o $(OBJDIR)cString.o $(OBJDIR)cData.o $(OBJDIR)cLogger.o $(OBJDIR)frameworkMain.o $(OBJDIR)cVector2.o $(OBJDIR)cBinaryFile.o $(OBJDIR)cEventSDL2.o $(OBJDIR)cEventManager.o $(OBJDIR)eventsMain.o $(OBJDIR)storm.o $(OBJDIR)cSoundBase.o $(OBJDIR)cMusicBase.o $(OBJDIR)cAudioBase.o $(OBJDIR)cAudioManager.o 
	$(CC) $(CFLAGS) $(OBJDIR)main.o $(OBJDIR)cAnimation.o $(OBJDIR)cAnimationManager.o $(OBJDIR)animationMain.o $(OBJDIR)cMain.o $(OBJDIR)cTimedCallbackManager.o $(OBJDIR)cTextureManager.o $(OBJDIR)cGraphicsSDL2.o $(OBJDIR)cTextureSDL2.o $(OBJDIR)cGraphicsManager.o $(OBJDIR)graphicsMain.o $(OBJDIR)cGraphicsBase.o $(OBJDIR)cTextureBase.o $(OBJDIR)statesMain.o $(OBJDIR)cStateManager.o $(OBJDIR)cStateBase.o $(OBJDIR)cFileSystem.o $(OBJDIR)cFileParser.o $(OBJDIR)cString.o $(OBJDIR)cData.o $(OBJDIR)cLogger.o $(OBJDIR)frameworkMain.o $(OBJDIR)cVector2.o $(OBJDIR)cBinaryFile.o $(OBJDIR)cEventSDL2.o $(OBJDIR)cEventManager.o $(OBJDIR)eventsMain.o $(OBJDIR)storm.o $(OBJDIR)cSoundBase.o $(OBJDIR)cMusicBase.o $(OBJDIR)cAudioBase.o $(OBJDIR)cAudioManager.o  -o "$(EXNAME)" $(LIBS)