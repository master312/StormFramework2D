...
$(OBJDIR)interuptMain.o: src/storm/core/interupts/interuptMain.cpp src/storm/core/interupts/interuptMain.h
	$(CC) $(CFLAGS) -c src/storm/core/interupts/interuptMain.cpp $(LIBS) -o $(OBJDIR)interuptMain.o 
$(OBJDIR)cInteruptManager.o: src/storm/core/interupts/cInteruptManager.cpp src/storm/core/interupts/cInteruptManager.h
	$(CC) $(CFLAGS) -c src/storm/core/interupts/cInteruptManager.cpp $(LIBS) -o $(OBJDIR)cInteruptManager.o 
