...
$(OBJDIR)interruptMain.o: src/storm/core/interrupts/interruptMain.cpp src/storm/core/interrupts/interruptMain.h
	$(CC) $(CFLAGS) -c src/storm/core/interrupts/interruptMain.cpp $(LIBS) -o $(OBJDIR)interruptMain.o 
